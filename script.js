...
const pageIds = ['gamePage', 'cakePage', 'notePage', 'memoriesPage', 'giftPage'];
...
const balloonColors = [
    'radial-gradient(circle at 30% 30%, #ff6ea1, #cc2a62)',
    'radial-gradient(circle at 30% 30%, #ff9ec1, #db417f)',
    'radial-gradient(circle at 30% 30%, #ff99c2, #d73b70)',
    'radial-gradient(circle at 30% 30%, #ff7ab6, #bc2f65)',
    'radial-gradient(circle at 30% 30%, #ff4da6, #aa2a57)',
    'radial-gradient(circle at 30% 30%, #ff88b3, #bf3b74)'
];
...
// Allow swipe on carousel (mobile)
let startX = 0;
